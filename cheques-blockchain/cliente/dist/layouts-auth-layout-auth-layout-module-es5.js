...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["layouts-auth-layout-auth-layout-module"], {
  ...
  function srcAppPagesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_transactions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onEnviar() {
          ...
          Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["clearAuth"])();
          Object(_services_transactions__WEBPACK_IMPORTED_MODULE_3__["clearPrivateKey"])();
          var cedula2 = this.cedula.toString();
          var credentials = {
            username: cedula2,
            password: Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["hashPassword"])(this.password)
          };
          Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["post"])('authorization', credentials).then(function (res) {
            Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["setAuth"])(res.authorization);
            Object(_services_transactions__WEBPACK_IMPORTED_MODULE_3__["setPrivateKey"])(_this.password, res.encryptedKey);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], LoginComponent);
    /***/
  },
  ...
  function srcAppPagesRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onEnviar() {
          ...
          var keys = Object(_services_transactions__WEBPACK_IMPORTED_MODULE_3__["makePrivateKey"])(this.password);
          var state = {
            'username': this.cedula.toString(),
            'email': this.nombre,
            'name': this.nombre
          };
          var user = lodash__WEBPACK_IMPORTED_MODULE_6__["assign"](keys, lodash__WEBPACK_IMPORTED_MODULE_6__["pick"](state, 'username', 'email'));
          user.password = Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["hashPassword"])(this.password);

          var agent2 = _services_payloads__WEBPACK_IMPORTED_MODULE_2__["obj"].createAgent(lodash__WEBPACK_IMPORTED_MODULE_6__["pick"](state, 'name'));

          Object(_services_transactions__WEBPACK_IMPORTED_MODULE_3__["submit"])(agent2, true, this.password).then(function () {
            return Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["post"])('users', user);
          }).then(function (res) {
            return Object(_services_api__WEBPACK_IMPORTED_MODULE_4__["setAuth"])(res.authorization);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])], RegisterComponent);
    /***/
  }
}]);
